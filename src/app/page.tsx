  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-canvas text-text-primary">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-8 sm:px-10 lg:px-12">
        <ScrollReveal>
        <nav className="sticky top-5 z-40 flex items-center justify-between rounded-full border border-border-subtle bg-surface/70 px-5 py-4 shadow-2xl shadow-black/20 backdrop-blur-xl">
